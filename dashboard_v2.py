#!/usr/bin/env python3
"""
Web Dashboard v2 for Telegram Monitor
Improved design with better colors, readability, and UX.
"""
...
def messages():
    ...
    return render_template('messages_v2.html',
                         messages=msgs,
                         stats=stats,
                         page=page,
...
if __name__ == '__main__':
    print("=" * 50)
    print("  Telegram Monitor Dashboard v2")
    print("=" * 50)
